...
function Globe() {
    ...
    // Exact center of India
    const indiaPos = useMemo(() => latLngToVec3(20.5937, 78.9629, 2.12), [])
    // Exact center of US
    const usPos = useMemo(() => latLngToVec3(37.0902, -95.7129, 2.12), [])
...
function FlightPath() {
    ...
    // Start exactly at India center, end exactly at US center
    const arcPoints = useMemo(() => {
        const pts: THREE.Vector3[] = []
        const startLat = 20.5937, startLng = 78.9629
        const endLat = 37.0902, endLng = -95.7129
                ...
                <div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }}
                        ...
                        <a href="https://github.com/sivayendluri17/siva-portfolio" target="_blank" rel="noopener noreferrer"
                           ...
                           onMouseEnter={e => { e.currentTarget.style.background = 'rgba(201,168,76,0.15)'; e.currentTarget.style.borderColor = '#c9a84c'; e.currentTarget.style.boxShadow = '0 0 25px rgba(201,168,76,0.4), 0 4px 15px rgba(0,0,0,0.2)'; e.currentTarget.style.transform = 'translateY(-2px)' }}
                        ...
                        <a href="https://www.linkedin.com/in/siva-yendluri/" target="_blank" rel="noopener noreferrer"
                           style={{ width: 42, height: 42, borderRadius: 10, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', transition: 'all 0.3s ease', boxShadow: '0 4px 15px rgba(0,0,0,0.2)' }}
                           onMouseEnter={e => { e.currentTarget.style.background = 'rgba(96,165,250,0.15)'; e.currentTarget.style.borderColor = '#60a5fa'; e.currentTarget.style.boxShadow = '0 0 25px rgba(96,165,250,0.4), 0 4px 15px rgba(0,0,0,0.2)'; e.currentTarget.style.transform = 'translateY(-2px)' }}
                           onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.05)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.12)'; e.currentTarget.style.boxShadow = '0 4px 15px rgba(0,0,0,0.2)'; e.currentTarget.style.transform = 'translateY(0)' }}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginLeft: '4px' }}>
                            ...
                            <span style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.45)', fontFamily: 'Inter, sans-serif', letterSpacing: 1 }}>India</span>
                            <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#60a5fa', boxShadow: '0 0 12px #60a5fa, 0 0 6px #60a5fa', marginLeft: '8px' }}></div>
                            <span style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.45)', fontFamily: 'Inter, sans-serif', letterSpacing: 1 }}>United States</span>
                        </div>
                    </motion.div>
                    ...
                    <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
                              style={{
                                  ...
                                  paddingLeft: '1.2rem',
                                  background: 'linear-gradient(135deg, rgba(255,255,255,0.75) 0%, rgba(201,168,76,0.6) 50%, rgba(255,255,255,0.75) 100%)',
                ...
                {b.label}
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.65 }}
                        ...
                        <button onClick={() => setActive('Projects')}
                                style={{ background: 'linear-gradient(135deg, #c9a84c 0%, #e8c96a 50%, #c9a84c 100%)', backgroundSize: '200% 200%', color: '#0a1628', padding: '0.85rem 2.4rem', border: 'none', borderRadius: 8, fontWeight: 700, fontSize: '0.88rem', cursor: 'pointer', fontFamily: 'Inter, sans-serif', letterSpacing: 1, textTransform: 'uppercase', boxShadow: '0 4px 25px rgba(201,168,76,0.4), 0 1px 0 rgba(255,255,255,0.2) inset', transition: 'all 0.3s ease' }}
                                onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = '0 8px 35px rgba(201,168,76,0.6), 0 1px 0 rgba(255,255,255,0.2) inset' }}
                                onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 25px rgba(201,168,76,0.4), 0 1px 0 rgba(255,255,255,0.2) inset' }}>
                            View My Work
                        </button>
                        <button onClick={() => setActive('About')}
                                ...
                                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(201,168,76,0.1)'; e.currentTarget.style.borderColor = '#c9a84c'; e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = '0 0 25px rgba(201,168,76,0.2), 0 4px 15px rgba(0,0,0,0.2)' }}
