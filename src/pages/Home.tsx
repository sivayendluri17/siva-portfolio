  ...
  return (
    <div style={{ minHeight: '100vh', paddingTop: 64, display: 'flex', alignItems: 'center', position: 'relative' }}>
      <div style={{
        ...
        padding: isMobile ? '2rem 1.2rem 3rem' : '4rem 2rem',
        display: 'grid',
        ...
        <div>
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}
            style={{ fontFamily: 'Playfair Display, serif', fontSize: isMobile ? '2.6rem' : 'clamp(3rem,6vw,5.2rem)', fontWeight: 900, lineHeight: 1.0, marginBottom: '1.2rem', color: '#ffffff', letterSpacing: -2, textShadow: '0 2px 40px rgba(201,168,76,0.2), 0 0 80px rgba(201,168,76,0.08)' }}>
            Siva<br />Yendluri
          </motion.h1>

          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }}
            style={{ display: 'flex', gap: '12px', marginBottom: '2rem', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.65 }}
            style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: isMobile ? '2rem' : '3rem' }}>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
            ...
            {[['4+', 'Years Experience'], ['15+', 'Projects Delivered'], ['2x', 'AWS Certified'], ['3', 'Companies']].map(([num, lbl]) => (
              <div key={lbl}>
                <div style={{ fontFamily: 'Playfair Display, serif', fontSize: isMobile ? '1.8rem' : '2.2rem', fontWeight: 700, color: '#c9a84c', textShadow: '0 0 25px rgba(201,168,76,0.4)' }}>{num}</div>
        ...
        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.4, duration: 0.8 }}
          style={{ height: isMobile ? 340 : 520, position: 'relative', width: '100%' }}>
          <Canvas camera={{ position: [0, 0, isMobile ? 6 : 5], fov: 58 }}>
            <GlobeScene />
          </Canvas>
          <div style={{ position: 'absolute', bottom: 10, left: '50%', transform: 'translateX(-50%)', fontSize: '0.65rem', color: 'rgba(255,255,255,0.2)', textAlign: 'center', whiteSpace: 'nowrap', letterSpacing: 2, fontFamily: 'Inter, sans-serif', fontWeight: 500 }}>
            DRAG TO EXPLORE
          </div>
        </motion.div>
      </div>
