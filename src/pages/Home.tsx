...
function Globe() {
    ...
    // Andhra Pradesh, India - your home
    const indiaPos = useMemo(() => latLngToVec3(15.9129, 79.7400, 2.12), [])
    // New York, USA - where you are now
...
function FlightPath() {
    ...
    const arcPoints = useMemo(() => {
        ...
        const startLat = 15.9129, startLng = 79.7400
